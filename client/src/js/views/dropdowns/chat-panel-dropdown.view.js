...
`;
    ...
    select(elementStrings.dropdowns.chatPanelDropdown).style.setProperty('transition', 'all 1s');
    select(elementStrings.dropdowns.chatPanelDropdown).style.setProperty('transform', 'scale(1)');
};
